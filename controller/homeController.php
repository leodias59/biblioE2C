...
<body>
    ...
    <div id="rangement">
        <main>
            ...
            <div class="intertext it2">
                <h4>Next Gen dans la place</h4>
            </div>
            <article>
